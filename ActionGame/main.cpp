...
int WINAPI WinMain(HINSTANCE hI, HINSTANCE hP, LPSTR lp, int nC)
{
	...
	Fish::PicHandle = LoadGraph("pictures/enemy_gun.png");	//�����摜�Z�b�g
	Crab::PicHandle = LoadGraph("pictures/enemy_gun.png");	//�J�j�摜���Z�b�g
	...
	SnowMan::PicHandle = LoadGraph("pictures/SnowMan.png");//Debug�p���摜
	SnowBall::PicHandle = LoadGraph("pictures/SnowBall.png");//Debug�p���摜
...
void CreateStage1_3R();
void CreateStage_MiniGame1();			//�^�C���������~�j�Q�[��
void CreateSampleBoss();	//boss�쐬debug�p
