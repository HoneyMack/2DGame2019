...
//サウンド管理用
enum {
	SOUND_FLASHBLOCK, SOUND_PLAYERJUMP,SOUND_PLAYERSKILL,SOUND_PLAYERJUMPMINI,SOUND_LASERSHOT,SOUND_DAMAGE,SOUND_ENEMYSHOOT,SOUND_JUMPSPRING,SOUND_JUMPSPRINGMINI,SOUND_ROPEJUMP,SOUND_ENEMYTREAD,SOUND_COIN,SOUND_STAGESTART,SOUND_STAGE1_1,SOUND_STAGE1_2,SOUND_STAGE1_3,SOUND_STAGE_SNOW,SOUND_STAGE_SEA,
	SOUND_STAGE_SKY,SOUND_STAGE_TUTO,SOUND_BOSS,SOUND_BOSS_DEFEAT,SOUND_HEALING,SOUND_UNI,SOUND_MAX
};
